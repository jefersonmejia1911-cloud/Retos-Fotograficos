...
// ==========================================
const retos = [
  { id: 1, texto: "RETRATO", texturaSrc: "textura_1.png", ejemploImg: "ejemplo-RETRATO.jpg", textoejemplo: "RETRATO: Imágenes que tengan como personaje a las personas del barrio" },
  { id: 2, texto: "TEXTURAS", texturaSrc: "textura_2.png", ejemploImg: "ejemplo-TEXTURAS.jpg", textoejemplo: "TEXTURAS: Capturar texturas asociadas al entorno, tales como escaleras, puertas, paredes…" },
  { id: 3, texto: "SOMBRAS", texturaSrc: "textura_1.png", ejemploImg: "ejemplo-SOMBRAS.jpg", textoejemplo: "SOMBRAS: Utilizar la luz solar o artificial para componer una imagen enfocada en siluetas o sombras." },
  { id: 4, texto: "REFLEJOS", texturaSrc: "textura_2.png", ejemploImg: "ejemplo-REFLEJOS.jpg", textoejemplo: "REFLEJOS: Registrar imágenes reflejadas en superficies como charcos, vidrios, espejos o superficies metálicas." },
  { id: 5, texto: "HORA DORADA", texturaSrc: "textura_1.png", ejemploImg: "ejemplo-HORA-DORADA.png", textoejemplo: "HORA DORADA: Aprovechar las platabandas y el horario para retratar los atardeceres en el barrio" },
  { id: 6, texto: "ALGO EN MOVIMIENTO", texturaSrc: "textura_2.png", ejemploImg: "ejemplo-MOVIMIENTO.png", textoejemplo: "ALGO EN MOVIMIENTO: Retratar el movimiento cotidiano dentro del barrio o dentro de la ruta." }
];
...
if (btnEjemplo) {
  btnEjemplo.addEventListener("click", () => {
    ...
    if (textoEjemplo) textoEjemplo.innerText = retoSeleccionado.textoejemplo; // 👈 NUEVO
...
// Enviar formulario Sustituye con la URL que acabas de copiar de Google Apps Script:
const scriptURL = "https://script.google.com/macros/s/AKfycbxsGx4Jth899wrO6PO1j2y0o0rG5_b3-ACo3ONkDgx7xgg2igGuaVSL__-Ux70AHlObrQ/exec";
...
if (formEnviar) {
  formEnviar.addEventListener("submit", (e) => {
    ...
    const selectCategoria = document.getElementById("selectCategoria") 
      ...
      : (retoSeleccionado ? retoSeleccionado.texto.replace('\n', ' ') : "SIN_RETO");
    const inputFoto = document.getElementById("inputFoto").files[0];
    const btnSubmit = formEnviar.querySelector(".submit-btn");
   ...
   reader.onload = function () {
      const payload = {
        ...
        nombreArchivo: inputFoto.name,
        mimeType: inputFoto.type,
        archivoBase64: reader.result
      };

      // 💡 CORRECCIÓN: Convertir payload a string y enviarlo con mode: "no-cors" o como Blob/URLSearchParams
      fetch(scriptURL, {
        method: "POST",
      ...
      .then(data => {
        if (data.status === "success") {
          alert("¡Tu fotografía y datos se han registrado exitosamente!");
          formEnviar.reset();
          cerrarModal("modalEnviar");
        } else {
      ...
      .catch(error => {
        ...
        alert("Error de conexión al subir los datos.");
      })
      .finally(() => {
